      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="relative w-24 h-24 mb-8 flex items-center justify-center">
          <motion.div
            ...
            className="absolute inset-0 rounded-full border border-dashed border-[#F59E0B]/40"
          />
          <motion.div
            animate={{ rotate: -360 }}
            transition={{ duration: 12, repeat: Infinity, ease: "linear" }}
            className="absolute inset-4 rounded-full border border-dashed border-[#FCD34D]/30"
          />
        ...
        {/* Progress Bar */}
        <div className="w-48 h-[2px] bg-[#141414] overflow-hidden rounded-full">
          <motion.div 
            className="h-full bg-gradient-to-r from-[#FBBF24] to-[#D97706]"
            initial={{ width: "0%" }}
